...
ANNOTATION_CONFIG = {
    ...
    'line_thickness_base': 4,           # Базовая толщина для изображения высотой 800px
    ...
    'font_size_base': 38,               # Базовый размер для изображения высотой 800px
    'font_size_min': 16,                # Минимальный размер шрифта
    'font_size_max': 60,                # Максимальный размер шрифта
    
    # Коэффициенты для отступов текста
    'text_padding': 3,                  # Отступ текста от краев подложки
    'text_offset': 1.5,                 # Отступ текста от bounding box
