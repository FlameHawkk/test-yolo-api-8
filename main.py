...
ANNOTATION_CONFIG = {
    ...
    'line_thickness_base': 3.5,         # Базовая толщина для изображения высотой 800px
    'line_thickness_min': 1.6,          # Минимальная толщина
    'line_thickness_max': 8,            # Максимальная толщина
    
    # Коэффициенты для расчета размера шрифта
    'font_size_base': 32,               # Базовый размер для изображения высотой 800px
    'font_size_min': 16,                # Минимальный размер шрифта
    'font_size_max': 52,                # Максимальный размер шрифта
